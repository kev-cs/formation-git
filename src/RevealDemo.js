  ...
  <>
        ...
        <a
          ...
          onClick={() => {
            document
              ...
              .setAttribute("href", "css/theme/black.css");
            return false;
          }}
        >
          Black (default)
    ...
    <section>
      ...
      >
        ...
        <pre>
          <code className="hljs html" style={{ "word-wrap": "break-word" }}>
            &lt;section data-background="image.png"
    ...
    >
      ...
      <pre>
        <code className="hljs javascript">{`Reveal.configure({backgroundTransition: 'zoom'})`}</code>
      </pre>
    </section>
    ...
    <section>
      <h2>Pretty Code</h2>
      <pre>
        <code className="hljs" data-trim data-line-numbers="4|9|4,8-11">
          {`
...
function Example() {
    ...
    <section>
      ...
      <p>
        There's a{" "}
        <a href="https://github.com/hakimel/reveal.js#speaker-notes">
          speaker view
        </a>
    ...
    <section>
      ...
      <p>
        ...
        <code>"something"</code>
        will be added as a className to the document element when the slide is
        open. This lets you apply broader style changes, like switching the page
        background.
      </p>
    </section>
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          <a href="https://github.com/hakimel/reveal.js#api">
            Extensive JavaScript API
          </a>
        </li>
        <li>
          <a href="https://github.com/hakimel/reveal.js#auto-sliding">
            Auto-progression
          </a>
        </li>
        <li>
          <a href="https://github.com/hakimel/reveal.js#parallax-background">
            Parallax backgrounds
          </a>
        </li>
        <li>
          <a href="https://github.com/hakimel/reveal.js#keyboard-bindings">
