    ...
    <>
      ...
      <section id={whatIsGitSlideId}>
        <section>
          ...
          <p className={nextStepClass}>
            C'est un gestionnaire de versions de sources distribué, créé en
            2005, par <b>Linus Torvalds</b>.
          </p>
          <p className={nextStepClass}>
          ...
          <p className={nextStepClass} style={{ fontStyle: "italic" }}>
            (Allez sur{" "}
            <a
              href="https://en.wikipedia.org/wiki/Git#Adoption"
              target="_blank"
            >
              wikipédia
            </a>{" "}
      ...
      <section id={howGitWorksSlideId}>
        ...
        <section>
          ...
          <ul>
            ...
            <li className={nextStepClass}>
              En ligne de commande, allez dans le répertoire et faites la
              commande suivante :
        ...
        <section>
          ...
          <ol style={{ fontSize: "xx-large" }}>
            ...
            <li className={nextSemiFadeClass}>
              <code style={inlineCodeStyle}>git commit</code> pour créer un
              commit contenant les modifications situées dans le{" "}
              <b>Staging Area</b>.
              <ul style={{ listStyleType: "none", fontStyle: "italic" }}>
                <li>
      ...
      <section id={mergeAndRebaseSlideId}>
        ...
        <section>
          ...
          />
          <p className={nextStepClass} style={{ fontStyle: "italic" }}>
            Notez que les branches ont maintenant le <b>même historique</b>.
            Elles sont donc <b>synchronisées</b>.
          </p>
        ...
        <section>
          ...
          <ul>
            ...
            <li className={nextStepClass}>
              Les rebases "reconstruisent" l'historique d'une branche en se
              fiant sur une <b>branche source</b>
            </li>
        ...
        <section>
          ...
          <p className={nextStepClass}>
            Les merges de branches qui n'ont pas la même historique produisent
            des <b>merge-commits</b> (3-way merge)
          </p>
          <p className={nextStepClass}>
      ...
      <section id={pullRequestsSlideId}>
        ...
        <section>
          ...
          <div style={{ fontSize: "2rem" }}>
            ...
            <p className={nextStepClass}>
              Si vous avez plusieurs commits similaires, fusionnez-les (à
              venir).
            </p>
            <p className={nextStepClass}>
      ...
      <section id={workflowsSlideId}>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Plus facile à perdre le fil du travail en cours à tous les
              endroits (surtout pour les grosses équipes)
            </li>
            <li>
              Inspiré du Feature Branching. Peut être mitigé en adoptant des
              pratiques d'intégration continue ou du Trunk Development.
              (fréquence des fusions principalement).
            </li>
          </ul>
        </section>
        <section>
